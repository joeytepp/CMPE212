...
class TestLineItem {
	...
	void testCompareTo() throws Exception {
		...
		LineItem lower = new LineItem(2, new Pizza("small", "double", "none", "none")); // total cost $10
		LineItem higher1 = new LineItem(2, new Pizza("small", "double", "none", "single")); // total cost $23
		LineItem higher2 = new LineItem(2, new Pizza("medium", "double", "none", "single")); //
		LineItem highest = new LineItem(10, new Pizza("small", "double", "none", "single")); // total cost $100
